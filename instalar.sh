...
# 2. Instalar PyQt5 na venv se necessário
...
# 3. Remover velho biblia.py do bin (se existir)
rm -f "$BIN_DIR/biblia.py"

# 4. Copiar biblia.py -> ~/.local/bin/biblia (sem extensão)
echo "Instalando executável..."
cp "$SCRIPT_DIR/biblia.py" "$BIN_DIR/biblia"

# 5. Shebang para a venv
